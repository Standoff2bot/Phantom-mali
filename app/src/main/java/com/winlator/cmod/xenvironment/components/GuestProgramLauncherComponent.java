...
public class GuestProgramLauncherComponent extends EnvironmentComponent {
    ...
    private int execGuestProgram() {
        ...
        if (renderer.contains("Mali")) {
            ...
            // Apply comprehensive Mali-G710 Box64 optimizations
            java.util.Map<String, String> maliBox64Vars = 
                com.winlator.cmod.core.MaliGPUOptimizer.getMaliBox64OptimizedEnvVars();
            execEnvVars.putAll(maliBox64Vars);
            
            Log.i("GuestProgramLauncher", "Applied Mali Box64 optimizations: " + 
                  maliBox64Vars.size() + " variables");
        }
